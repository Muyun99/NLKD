...
def co_teaching(mask_pred_teacher, mask_pred_student, true_masks, ratio=0.5):
    ...
    return idx_student, idx_teacher
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc='Epoch {}/{}/val_stu:{}/val_tea:{}/idx:{}'.format(epoch + 1, epochs, val_score_student, val_score_teacher, epoch_smaple, unit='img')) as pbar:
            for batch in train_dataloader:
                ...
                idx_student, idx_teacher = co_teaching(mask_pred_teacher, mask_pred_student, true_masks)
